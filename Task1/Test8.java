...
public class Test8 {
    ...
    public static void emptyCart(WebDriver driver) {
        List<WebElement> cartFooter = driver.findElement(By.tagName("tfoot")).findElements(By.tagName("tr"));
        cartFooter.get(1).findElement(By.tagName("ng-confirm")).findElement(By.tagName("a")).click();
